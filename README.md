...
- Para la permanencia de los datos se utiliza el sistema gestor de SQL Server.

- Para realizar la conexión con la base de datos y el manejo de los datos, se utiliza la tecnología de ADO.Net Entity Framework.
